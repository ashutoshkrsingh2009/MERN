  ...
  return (
    <section className="panel flex min-h-[640px] flex-col rounded-2xl p-5 sm:p-6">
      <div className="border-b border-slate-200 pb-5">
        <p className="text-sm font-semibold text-emerald-600">ATS report</p>
        ...
        <div className="max-w-md">
          <div
            className={`mx-auto grid h-16 w-16 place-items-center rounded-2xl ${
              isError ? "bg-red-50 text-red-700" : "bg-blue-50 text-emerald-600"
            }`}
          >
            {isLoading ? (
<span className="h-7 w-7 animate-spin rounded-full border-2 border-emerald-200 border-t-emerald-600" />            ) : (
