  ...
  return (
    <section className="panel flex min-h-[640px] flex-col rounded-2xl p-5 sm:p-6">
      <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-5">
        <div>
          <p className="text-sm font-semibold text-emerald-600">Resume input</p>
        ...
        <button
          type="button"
          onClick={handleReset}
          className="focus-ring rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-black shadow-sm transition hover:border-slate-300 hover:bg-emerald-600 disabled:opacity-50"
      ...
      <div className="flex flex-1 flex-col gap-5 pt-5">
        <div>
          ...
          <button
            ...
            disabled={isAnalyzing || isUploading}
            className="focus-ring flex min-h-24 w-full items-center justify-between gap-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-left transition hover:border-emerald-600  disabled:opacity-60"
          >
            <span className="flex min-w-0 items-center gap-4">
              <span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-emerald-600 text-sm font-bold text-white shadow-sm">
                PDF
              </span>
            ...
            {isUploading ? (
              <span className="h-5 w-5 shrink-0 animate-spin rounded-full border-2 border-emerald-600 border-t-emerald-600" />
            ) : (
              <span className="rounded-full bg-white px-3 py-1.5 text-xs font-bold text-black shadow-sm hover:bg-emerald-600">
                Browse
              </span>
            )}
          </button>
        ...
        <button
          ...
          disabled={!canAnalyze}
          className="focus-ring inline-flex h-12 items-center justify-center rounded-xl bg-emerald-300 px-5 text-sm font-bold text-black shadow-sm transition hover:bg-emerald-600 hover:shadow-md active:scale-[0.99] disabled:bg-slate-300 disabled:text-slate-500 disabled:shadow-none"
        >
          {isAnalyzing ? (
